...
enum Origin {
    ...
    init?(forEthereumEventElement eventElementOrigin: XMLElement, eventSourceElement: XMLElement, sourceContractElement: XMLElement, xmlContext: XmlContext) {
        ...
        guard let eventDefinition = XMLHandler.getEventDefinition(contractElement: sourceContractElement, eventElement: eventSourceElement, xmlContext: xmlContext) else { return nil }
